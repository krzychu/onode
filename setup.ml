...
(* OASIS_START *)
(* DO NOT EDIT (digest: f78efbda88721e93457cd411d2684afb) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "onode"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "static_file_server.ml"
                   });
               Executable
                 ({
                     cs_name = "async_file_access";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "async_file_access.ml"
                   });
               Executable
                 ({
                     cs_name = "test_runner";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\011\130\233\248*\182E\181\196\012\138\004#Cu|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
